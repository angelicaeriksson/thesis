...
twoway (line _Y_treated _time, lcolor(black) lwidth(medthick) lpattern(solid)) (
> line _Y_synthetic_Original _time, lcolor(gray) lpattern(dash)) (line _Y_syntheti
> c_Finland _time, lcolor(green) lpattern(dash)) (line _Y_synthetic_Norway _time, 
> lcolor(red) lpattern(dash)) (line _Y_synthetic_UK _time, lcolor(dknavy) lpattern
> (dash)), ytitle(Numbers of passengers per capita) xtitle(Year) xline(2018, lpatt
> ern(dash) lcolor(black))
